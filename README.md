...
Master's [dissertation](https://drive.google.com/file/d/1zGMdfVmXrIFHtBi476NFZ3uB9hOGeYJA/view?usp=drive_link) in Computer Graphics, entitled: Modeling Volumetric Clouds.
...
The template project has all the examples present in the results section of the [dissertation](https://drive.google.com/file/d/1zGMdfVmXrIFHtBi476NFZ3uB9hOGeYJA/view?usp=drive_link) (using Material Instances).
The [dissertation](https://drive.google.com/file/d/1zGMdfVmXrIFHtBi476NFZ3uB9hOGeYJA/view?usp=drive_link) shall be used for any needed documentation.
